...
const api = {
  ...
  getTransaction: (id) => apiRequest(`/p2p/transactions/${id}`),
  getMyTransactions: () => apiRequest('/p2p/transactions/mine'),
  declarePaid: (id, proofScreenshotUrl) => apiRequest(`/p2p/transactions/${id}/declare-paid`, { method: 'POST', body: { proofScreenshotUrl } }),
